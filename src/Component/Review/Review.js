...
const Review = () => {
  ...
  smartSpeed={1000}
          ...
          <div  className='p-4 card' style={{width:"373px"}}>
              ...
              <div  className='text-left mt-3'><span style={{fontFamily:"Open Sans",fontSize:"17px",fontStyle:"italic",color:"#757575"}}>"Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam similique placeat tempore blanditiis natus dignissimos aut sequi distinctio asperiores possimus!"</span></div>
    ...
    fontFamily: "",
    fontSize: "22px",
    fontWeight: "700"}}>JAN DOE</span></div> 
