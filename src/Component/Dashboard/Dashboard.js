            ...
            <div className='row w-100'>
                ...
                <div className='p-4 text-center'><h1 style={{fontSize:"40px",letterSpacing:"10px",fontWeight:"700",color:"white",fontStretch: "expanded"}}>ONZO</h1> <h5 style={{color:"white",letterSpacing:"2px",marginTop:"10px"}}>DASHBOARD</h5></div>
                    ...
                    <div style={{color:"white",padding:"15px"}} className='text-center '>
                        ...
                        <div style={ {fontStyle:"poppins",
                    marginLeft:"10px",fontSize:"18px",fontWeight:"600",width:"100%",textAlign:"left"}}> Add A Product</div>
                    </div>
                        <div className='d-flex justify-content-center mt-4 dashnav'>
                        <div  style={{width:"25px",marginLeft:"10px"}}><MdManageAccounts size={25} /></div>
                        <div style={ {fontStyle:"poppins",
                    marginLeft:"10px",fontSize:"18px",fontWeight:"600",width:"100%",textAlign:"left"}}> Manage All Orders </div>
                    </div>
                        <div className='d-flex justify-content-center mt-4 dashnav'>
                        <div  style={{width:"25px",marginLeft:"10px"}}><MdProductionQuantityLimits size={25} /></div>
                        <div style={ {fontStyle:"poppins",
                    marginLeft:"10px",fontSize:"18px",fontWeight:"600",width:"100%",textAlign:"left"}}> Manage Product </div>
                    </div>
                        <div className='d-flex justify-content-center mt-4 dashnav'>
                        <div  style={{width:"25px",marginLeft:"10px"}}><MdOutlineAdminPanelSettings size={25} /></div>
                        <div style={ {fontStyle:"poppins",
                    marginLeft:"10px",fontSize:"18px",fontWeight:"600",width:"100%",textAlign:"left"}}> Make Admin </div>
                    </div>
                    <div>
                        <div className='mx-auto adminlogout' style={{border:"none",
                        display:"flex",
                ...
                <div className='col-md-8 mt-5'>
                    {/* ADD A PRODUCT  */}
                    <div style={{backgroundColor:"#6e54f5",borderRadius:"30px",padding:"25px"}}>
                    <div>  <div>
         ...
         <form onSubmit={addproductsubmit} action="">
                    <div className='d-flex'>
                        ...
                        <div className=' '>
                            ...
                            <button type="submit" className='mx-auto adminlogout' style={{border:"none",
                        display:"flex",
                        justifyContent:"center",
                        padding:"15px",
                        alighItems:"center",
